        ...
        <div class="row">
            ...
            <!-- TEST FOOTER 
                <section class = footer >
                    ...
                    <p class="text"> &copy; 2022 All Rights Reserved </p>
                </section> -->
            ...
            <div class="col">
                <div class="row">
                    <h4>Quick Links</h4>
                    <a href="about.php" class="footer-links" style="text-align:left;">About Us</a>
                    <a href="about.php" class="footer-links" style="text-align:left;">Support</a>
                    <a href="about.php" class="footer-links" style="text-align:left;">License</a>
                    <a href="about.php" class="footer-links" style="text-align:left;">Contact</a>
                </div>
            </div>
            <div class="col">
                <div class="row">
