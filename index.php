...
<body>
    ...
    include_once './phpFunctions/createUsersTables.php';
    include_once './phpFunctions/createJobsTable.php';
    include_once './phpFunctions/createJobApplicationTable.php';
    ?>
    <div class="m-5"></div>
    <div class="container text-center">
        <div class="title-container d-flex justify-content-center">
            ...
            <div class="title">
                <h1 style="font-size: 70px;">NamEduHire</h1>
            </div>
        </div>
        <div class="m-3"></div>
